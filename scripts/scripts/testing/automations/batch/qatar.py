...
sample_official_data = [
    ...
    (
        ...
        {
            SERIES_TYPE: 35757,
            "source": "https://www.moph.gov.qa/english/Pages/Coronavirus2019.aspx",
        },
    ),
    (
        "2020-05-19",
...
def get_data() -> pd.DataFrame:
    ...
    assert df.shape[0] < PARAMS["rows"], (
        "Number of records in dataset exceeds number of records requested. "
    ...
    df.rename(
        columns={
            "number_of_new_tests_in_last_24_hrs": "Daily change in cumulative total",
