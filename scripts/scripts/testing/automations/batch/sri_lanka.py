...
official_cumulative_totals = [
    (
        "2020-09-03",
        {
            "cumulative_total": 235221,
            "source": "http://web.archive.org/web/20200904152730/https://www.hpb.health.gov.lk/en",
        },
    ),
    (
        "2020-04-30",
        {
            "cumulative_total": 22418,
            "source": "http://web.archive.org/web/20200715071651/https://www.hpb.health.gov.lk/en",
        },
    ),
    (
        "2020-04-25",
        {
            "cumulative_total": 15393,
            "source": "http://web.archive.org/web/20200519033637/https://www.hpb.health.gov.lk/en",
        },
    ),
    (
        "2020-03-05",
