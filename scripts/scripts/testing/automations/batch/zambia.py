...
official_cumulative_totals = [
    (
        "2020-09-03",
        {
            "cumulative_total": 119567,
            "source": "https://twitter.com/mohzambia/status/1301477446936678400",
        },
    ),
    (
        "2020-08-08",
        {
            "cumulative_total": 93344,
            "source": "https://twitter.com/mohzambia/status/1292086483978014722",
        },
    ),
    (
        "2020-08-06",
        {
            "cumulative_total": 90307,
            "source": "https://twitter.com/mohzambia/status/1291398767959322629",
        },
    ),
    (
        "2020-07-30",
        {
            "cumulative_total": 81482,
            "source": "https://www.facebook.com/mohzambia/posts/1656823021159015",
        },
    ),
    (
        "2020-07-29",
        {
            "cumulative_total": 80239,
            "source": "https://www.facebook.com/mohzambia/posts/1655960864578564",
        },
    ),
    (
        "2020-07-28",
        {
            "cumulative_total": 79269,
            "source": "https://www.facebook.com/mohzambia/posts/1654985441342773",
        },
    ),
    (
        "2020-05-07",
        {
            "cumulative_total": 11412,
            "source": "https://twitter.com/mohzambia/status/1258424347011756033",
        },
    ),
    (
        "2020-04-30",
        {
            "cumulative_total": 6828,
            "source": "http://znphi.co.zm/news/wp-content/uploads/2020/05/Zambia_COVID-Situational-Report-No-43_30April20_Final.pdf",
        },
    ),
    (
        "2020-04-09",
        {
            "cumulative_total": 1314,
            "source": "http://znphi.co.zm/news/wp-content/uploads/2020/04/Zambia_COVID-Situational-Report-No-22_09April20_Final.pdf",
        },
    ),
    (
        "2020-04-08",
        {
            "cumulative_total": 1222,
            "source": "http://znphi.co.zm/news/wp-content/uploads/2020/04/Zambia_COVID-Situational-Report-No-21_08April20_Final.pdf",
        },
    ),
    (
        "2020-04-07",
        {
            "cumulative_total": 1087,
            "source": "http://znphi.co.zm/news/wp-content/uploads/2020/04/Zambia_COVID-Situational-Report-No-20_07April20_Final.pdf",
        },
    ),
    (
        "2020-03-31",
        {
            "cumulative_total": 520,
            "source": "http://znphi.co.zm/news/wp-content/uploads/2020/04/Zambia_COVID-Situational-Report-No-13_310320_Final.pdf",
        },
    ),
    (
        "2020-03-22",
        {
            "cumulative_total": 75,
            "source": "http://znphi.co.zm/news/wp-content/uploads/2020/03/Zambia_COVID-Situational-Report-No-4_220320_final.pdf",
        },
    ),
]
...
def get_data() -> pd.DataFrame:
    ...
    df["reportdt"] = (
        df["reportdt"]
        .astype(int)
        .apply(lambda dt: datetime.datetime.utcfromtimestamp(dt / 1000))
    )
...
def sanity_checks(df: pd.DataFrame) -> None:
    ...
    assert (
        df["Cumulative total"].iloc[1:] >= df["Cumulative total"].shift(1).iloc[1:]
