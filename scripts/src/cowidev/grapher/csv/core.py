...
class Grapheriser:
    def __init__(self, location: str = "location", date: str = "date",
                 date_ref: datetime = datetime(2020, 1, 21), fillna: bool = False, fillna_0: bool = True,
                 pivot_column: str = None, pivot_values: str = None) -> None:
